...
namespace Line_Comparision
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int lineStatus = line1.CompareTo(line2);//compare to method

            if (lineStatus > 0)
            {
                Console.WriteLine("Line is greater than line two");
            }
            else if (lineStatus < 0)
            {
                Console.WriteLine("Line is greater than line one");
            }
            else
            {
                Console.WriteLine("Line is equal to line two");
